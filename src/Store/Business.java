...
//	}
	 ...
	 */
	public static List<String> getActiveCustomer(String storeId) throws SQLException {
	 ...
	 */
	public static List<Store> getStoreInfo(String storeId) throws SQLException {
		List<Store> stores = new ArrayList<Store>();
